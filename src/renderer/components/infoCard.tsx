...
import { EditState, InfoCardProps, WritingData } from '@src/structure';
...
export const InfoCard: React.FC<InfoCardProps> = (props) => {
  ...
  return (
    <Link to="/edit" state={props as EditState} className={linkClassNameBase + (props.disabled ? 'disabled-link' : '')}>
